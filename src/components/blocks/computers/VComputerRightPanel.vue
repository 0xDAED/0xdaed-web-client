<script setup>
  ...
  import { useComputerCommands } from '@/composables/computers/useCommands'

  import { PANEL_TABS } from '@/composables/computers/panel/panelConstants'
  import { useComputerPanelMeta } from '@/composables/computers/panel/useComputerPanelMeta'
  import { useProcessesPanel } from '@/composables/computers/panel/useProcessesPanel'
  import { useTasksPanel } from '@/composables/computers/panel/useTasksPanel'
  ...
  const { computerId, statusBadge, statusColor, systemStats } = useComputerPanelMeta(computerRef)
